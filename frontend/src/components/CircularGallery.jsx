...
class GalleryApp {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: 'https://picsum.photos/seed/1/800/600?grayscale', text: 'Collection' },
    ];
...
export default function CircularGallery({ items, bend = 1, textColor = '#ffffff', borderRadius = 0.05, font = "bold 28px 'Space Grotesk Variable', sans-serif", scrollSpeed = 2, scrollEase = 0.05 }) {
